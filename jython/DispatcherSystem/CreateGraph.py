...
class StationGraph(jmri.jmrit.automat.AbstractAutomaton):
    def __init__(self):
        ...
        if self.logLevel > -1: print "graph vertices"
        self.setup_graph_vertices()
        if self.logLevel > -1: print "graph inhibited blocks"
    ...
    def setup_station_block_list(self):
        ...
        # Add any blocks associated with turntables
        ...
        for station in self.station_block_list:
            ...
            for i in range(station_block.getNumberOfNeighbours()):
                ...
                for destination in other_stations:
                    ...
                    j += 1
                    if self.logLevel > 0: print "--------------------------"
                    if self.logLevel > 0: print "destination", j ,destination, "iterating through other stations", other_stations
                    if self.logLevel > 0: print "--------------------------"
                    ...
                    try:
                        ...
                        if success:
                            ...
                            x = "no"
                            print "did not find optimal path"
    ...
    def Sufficient_signal_masts_in_edge(self, e):
        ...
        for panel in layoutPanels:
            ...
            if self.logLevel > 1: print "layout_block_list (path)",layout_block_list
            layout_block_list_name = e.getItem("path_name")
            if self.logLevel > 1: print "layout_block_list_name (path_name)",layout_block_list_name
            ...
            print "if signal_mast_list_for_panel is empty, getBeansInPath did not work"
