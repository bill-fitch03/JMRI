...
def countTrucksAgain(self, noTrucksToCount, sensor):
    ...
    # self.setSpeed(self.stop)
    # speak("end of move back")
    # self.waitMsec(5000)
    # #redo the original function up to the existing count

    # self.myprint("noTrucksToCount = ", glb_count)
    # speak("redo original function")
    # self.waitMsec(5000)
    # #change direction of travel
    # speak("setting direction of travel to head")
    # self.setDirection(fromBranch, 4)

    # self.waitMsec(5000)
    # noTrucksToCount = 1
    # self.storeTimeout(2)
    # speak("count one truck active")
    # self.waitMsec(5000)
    # self.setSpeed(self.slow)
    # self.countTrucksActive(noTrucksToCount, sensor)
    # self.myprint ("end alt_action_countTrucksActive2 ")
    # self.dedent()